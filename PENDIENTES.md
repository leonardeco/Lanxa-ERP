...
| 7 | Entregar [`MANUAL-DE-USUARIO.md`](./MANUAL-DE-USUARIO.md) a los usuarios y que cambien su contraseña inicial | ✅ Paquete 7 roles listo en Escritorio (`Entrega-SuperOzono-v030`). ⏸ **Aplazado a propósito (2026-07-15):** el Superusuario aún no entrega accesos a nadie. No borrar credenciales temporales hasta la entrega real |
