...
**Run 2–4 (2026-07-15):** tenancy foundation + RLS PG + **filtros `for_tenant` en listados/get críticos** + stamp `before_insert` + tests HTTP. Run 5 = onboarding multi-empresa / uniques compuestos.
